    ...
    return (
        <div>
            ...
            <form className="max-w-screen-xl mx-auto" onSubmit={handleSubmit}>
                <select name="status" className="border w-full mt-12 mb-6 py-3 rounded-lg">
                    <option value="todo">TODO</option>
                    <option value="ongoing">ONGOING</option>
                    <option value="completed">COMPLETED</option>
                </select>
                <div className="flex justify-center items-center">
                    <input className="py-1.5 w-full rounded bg-[#b63327] text-white hover:text-[#b63327] hover:bg-white hover:border hover:border-[#b63327] text-xs md:text-base" type="submit" value="Move" />
                </div>
            </form>
        </div>
    );
